...
export var logger = console.log; // for strings


// ---------------------------------------------------------------------------
// the default stringifier
export var tamlStringifier = function(obj) {
  var str;
  str = yaml.dump(obj, {
    skipInvalid: true,
    indent: 1,
...
export var stringifier = tamlStringifier;

// ---------------------------------------------------------------------------
export var setLogger = function(loggerFunc) {
  logger = loggerFunc;
};

// ---------------------------------------------------------------------------
export var setStringifier = function(stringifierFunc) {
